...
Shader "MC_shader"
{
	Properties
	{
		...
		_Color3("Color 3", Color) = (0.1226415,0.1226415,0.1226415,0)
		_TextureSample4("Texture Sample 4", 2D) = "white" {}
		[HDR]_FaceColor("FaceColor", Color) = (0,0,0,0)
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 temp_output_13_0 = step( temp_output_6_0 , temp_cast_2 );
			...
			float4 temp_cast_6 = (0.57).xxxx;
			o.Emission = ( ( tex2D( _TextureSample0, uv_TextureSample0 ) * _Color3 ) + ( ( ( tex2DNode112.r * color114 * tex2D( _TextureSample3, ( tex2DNode112 * saturate( ( abs( _SinTime.x ) + 0.2 ) ) * tex2D( _TextureSample2, panner123 ) ).rg ) * _RedGlowAmount ) * temp_output_13_0 ) + ( ( FireSurface212 * _BodyFireColor * temp_output_15_0 ) + ( tex2D( _BurnRamp, appendResult12 ) * temp_output_15_0 * step( temp_output_6_0 , temp_cast_6 ) * _Burnedgeboost ) ) + ( tex2D( _TextureSample4, i.uv_texcoord ) * _FaceColor ) ) ).rgb;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=17000
7;463;1906;549;732.8122;600.575;1.948115;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;2;-1808.84,700.7853;Float;False;Property;_DissolveAmount;Dissolve Amount;3;0;Create;True;0;0;False;0;0;0.49;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;220;595.1503,659.0954;Float;True;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;216;276.5439,743.3907;Float;False;Property;_Burnedgeboost;Burn edge boost;16;1;[HDR];Create;True;0;0;False;0;4,2.596858,1.759162,0;1.666772,1.835294,0.6245765,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;219;883.5704,705.2427;Float;False;Property;_FaceColor;FaceColor;19;1;[HDR];Create;True;0;0;False;0;0,0,0,0;10.68063,8.562121,0.9572257,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.WireNode;215;48.50505,-40.50905;Float;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;217;774.338,463.1674;Float;True;Property;_TextureSample4;Texture Sample 4;18;0;Create;True;0;0;False;0;None;41fe9141ab65c364c9271674998217b1;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;218;1096.177,626.1332;Float;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;153;755.4092,-468.9651;Float;False;Property;_Color3;Color 3;17;0;Create;True;0;0;False;0;0.1226415,0.1226415,0.1226415,0;0.1226415,0.1226415,0.1226415,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;129;1156.868,128.7568;Float;True;3;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;221;1415.959,15.02931;Float;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
