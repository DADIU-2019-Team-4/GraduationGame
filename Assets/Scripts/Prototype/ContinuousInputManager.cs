...
public class ContinuousInputManager : MonoBehaviour
{
    [SerializeField]
    ...
    private ContinuousMovementController movementController;
    ...
    private void Awake()
    {
        movementController = FindObjectOfType<ContinuousMovementController>();
    }
