...
Shader "MC_shader"
{
	Properties
	{
		...
		[HDR]_HairBoost("HairBoost", Color) = (0,0,0,0)
		[HDR]_BoduFireColor("BoduFireColor", Color) = (1.502837,0.161228,0,0)
	...
	SubShader
	{
		...
		uniform float4 _BoduFireColor;
		uniform float4 _HairBoost;
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 FireSurface212 = ( tex2DNode85 + ( tex2D( _FlameWave, panner75 ) * tex2DNode85 ) );
			...
			o.Emission = ( ( ( tex2DNode112.r * color114 * tex2D( _TextureSample3, ( tex2DNode112 * saturate( ( abs( _SinTime.x ) + 0.2 ) ) * tex2D( _TextureSample2, panner123 ) ).rg ) * _RedGlowAmount ) * temp_output_13_0 ) + saturate( ( ( ( FireSurface212 * _BoduFireColor * temp_output_15_0 ) * _HairBoost ) + ( tex2D( _BurnRamp, appendResult12 ) * temp_output_15_0 * step( temp_output_6_0 , temp_cast_7 ) ) ) ) ).rgb;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=17000
18;477;1907;571;-393.1582;98.21251;1;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;2;-1766.97,690.3179;Float;False;Property;_DissolveAmount;Dissolve Amount;3;0;Create;True;0;0;False;0;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.OneMinusNode;3;-1573.685,673.4609;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;91;-1982.845,106.0622;Float;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;11;-552.4686,494.2027;Float;False;Constant;_Float0;Float 0;6;0;Create;True;0;0;False;0;0.5;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;148;-1698.583,10.57629;Float;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.StepOpNode;13;-283.8517,487.3479;Float;True;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;212;-1376.26,83.42059;Float;False;FireSurface;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;109;-138.6907,-0.8556311;Float;False;Property;_BoduFireColor;BoduFireColor;16;1;[HDR];Create;True;0;0;False;0;1.502837,0.161228,0,0;1.502837,0.3203767,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;213;-83.93436,-121.9429;Float;False;212;FireSurface;1;0;OBJECT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;156;278.4337,219.6824;Float;False;Property;_HairBoost;HairBoost;15;1;[HDR];Create;True;0;0;False;0;0,0,0,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;22;243.512,-31.38011;Float;True;3;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;21;335.4303,395.1935;Float;True;3;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;158;500.9794,76.90974;Float;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SaturateNode;161;960.7964,167.8026;Float;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.BlendNormalsNode;111;1021.826,458.0126;Float;False;0;3;0;FLOAT3;1,1,1;False;1;FLOAT3;1,1,1;False;2;FLOAT3;0,0,0;False;1;FLOAT3;0
...
WireConnection;148;0;85;0
WireConnection;148;1;91;0
